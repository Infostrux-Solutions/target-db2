...
from .base import DB2Compiler, DB2Dialect, DB2ExecutionContext
...
class DB2Dialect_zxjdbc(ZxJDBCConnector, DB2Dialect):
    supports_unicode_statements = supports_unicode_binds = returns_unicode_strings = (
        supports_unicode
    ) = False
    ...
    def dbapi(cls):
        ...
        from com.ziclix.python.sql import FilterDataHandler, zxJDBC
        from java.sql import SQLException
        from java.sql import Types as java_Types
